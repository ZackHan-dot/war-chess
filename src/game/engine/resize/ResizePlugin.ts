...
type EngineOptions = ApplicationOptions & CreationResizePluginOptions;
type Engine = Application & CreationResizePluginOptions;
...
export class CreationResizePlugin {
     ...
     */
    public static init(options: EngineOptions): void {
        const app = this as unknown as Engine;
        ...
        app.resize = (): void => {
            ...
            const { width, height } = resize(
                canvasWidth,
                canvasHeight,
                app.resizeOptions!.minWidth as number,
                app.resizeOptions!.minHeight as number,
                app.resizeOptions!.letterbox as boolean
            );
